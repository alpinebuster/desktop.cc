...
{
    setWindowTitle(tr("Opened Files"));
    setDragEnabled(true);
    ...
    connect(HomeManager::instance(), &HomeManager::currentEditorChanged,
    ...
    updateCurrentItem(HomeManager::currentEditor());
}
...
void OpenEditorsWidget::activateEditor(const QModelIndex &index)
{
    ...
    HomeManager::activateEditorForEntry(
                DocumentModel::entryAtRow(m_model->mapToSource(index).row()));
}

void OpenEditorsWidget::closeDocument(const QModelIndex &index)
{
    HomeManager::closeDocuments({DocumentModel::entryAtRow(m_model->mapToSource(index).row())});
...
void OpenEditorsWidget::contextMenuRequested(QPoint pos)
{
    ...
    HomeManager::addSaveAndCloseEditorActions(&contextMenu, entry);
    contextMenu.addSeparator();
    HomeManager::addPinEditorActions(&contextMenu, entry);
    contextMenu.addSeparator();
    HomeManager::addNativeDirAndOpenWithActions(&contextMenu, entry);
...
{
    setId("Opened Files");
    setDisplayName(OpenEditorsWidget::tr("Opened Files"));
