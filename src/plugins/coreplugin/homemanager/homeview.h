...
public:
    explicit HomeView(SplitterOrView *parentSplitterOrView, QWidget *parent = nullptr);
    ~HomeView() override;

    SplitterOrView *parentSplitterOrView() const;
    HomeView *findNextView() const;
    HomeView *findPreviousView() const;
...
public:
    ...
    void copyNavigationHistoryFrom(HomeView* other);
...
public:
    ...
    explicit SplitterOrView(HomeView *view);
    ...
    inline HomeView *view() const { return m_view; }
    ...
    HomeView *findFirstView();
    HomeView *findLastView();
