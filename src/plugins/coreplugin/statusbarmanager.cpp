...
static void createStatusBarManager()
{
    ...
    // The stretch parameter is used to compute a suitable size
    // for the given widget as the status bar grows and shrinks.
    // The default stretch factor is 0,
    // i.e giving the widget a minimum of space
    bar->insertPermanentWidget(0, m_splitter, 1);
    // This property holds whether child widgets can be resized down to size 0
    m_splitter->setChildrenCollapsible(false);

    // First: Hide/Show left sidebar button
